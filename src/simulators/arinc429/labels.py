...
LABEL_REGISTRY: dict[str, LabelDef] = {
    ...
    "310": LabelDef(
        octal="310", decimal=200,
        name="Latitude",
        unit="deg",
        fmt=DataFormat.BNR,
        range_min=-90.0, range_max=90.0,
        resolution=0.000021,
        description="Aircraft latitude from GPS/IRS. "
                    "Injection attacks could feed false position to FMS.",
    ),
    "311": LabelDef(
        octal="311", decimal=201,
        name="Longitude",
        unit="deg",
        fmt=DataFormat.BNR,
        range_min=-180.0, range_max=180.0,
        resolution=0.000021,
    ...
    "164": LabelDef(
        octal="164", decimal=116,
        name="Fuel Flow (Eng 1)",
        unit="kg/h",
        fmt=DataFormat.BNR,
        range_min=0.0, range_max=15_000.0,
        resolution=0.5,
    ...
    "177": LabelDef(
        octal="177", decimal=127,
        name="Flap Position",
        unit="deg",
        fmt=DataFormat.BNR,
        range_min=0.0, range_max=45.0,
        resolution=0.022,
...
def get_label(octal_code: str) -> LabelDef:
    ...
    if octal_code not in LABEL_REGISTRY:
        raise KeyError(f"Unknown ARINC 429 label: {octal_code!r}. "
